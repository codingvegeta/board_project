...
import com.example.securityBoard.global.exception.DuplicateClientException;
import com.example.securityBoard.global.security.jwt.JwtUtils;
...
public class ClientService {
    ...
    public GetClientResponseDto findClient(GetClientRequestDto clientRequest) {
        Client client = clientRepository.findByRoleAndId(clientRequest.getRole(), clientRequest.getId())
